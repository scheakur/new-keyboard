...
static uint8_t const matrixMine[8][12] =
{
    ...
    KEY_LEFTCONTROL, KEY_2, KEY_3, KEY_4, KEY_5, 0, 0, KEY_6, KEY_7, KEY_8, KEY_9, KEY_QUOTE,
    KEY_Q, KEY_W, KEY_E, KEY_R, KEY_T, 0, 0, KEY_Y, KEY_U, KEY_I, KEY_O, KEY_P,
    KEY_A, KEY_S, KEY_D, KEY_F, KEY_G, KEY_LEFT_BRACKET, KEY_RIGHT_BRACKET, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON,
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_TAB, KEY_BACKSLASH, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTSHIFT, KEY_LEFT_GUI, KEY_LEFT_FN, KEY_SPACEBAR, KEY_BACKSPACE, KEY_LEFTALT, KEY_RIGHTALT, KEY_BACKSPACE, KEY_SPACEBAR, KEY_RIGHT_FN, KEY_RIGHT_GUI, KEY_RIGHTSHIFT
};
